...
/*
Establishes the interface which in this case, is the actual sudoku game
Draws all the components of a sudoku game, title, and messages
 */
...
public class UserInterfaceImpl implements IUserInterfaceContract.View,
    ...
    private static final Color WINDOW_BACKGROUND_COLOUR = Color.rgb(50,150,200);
    ...
    public void showDialog(String message) {
        Alert text = new Alert(Alert.AlertType.CONFIRMATION, message, ButtonType.OK);
        text.showAndWait();

        if (text.getResult() == ButtonType.OK) listener.onDialogClick();
    }
